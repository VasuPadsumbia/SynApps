...
/* Generated from ../O.Common/delaygenApp.dbd */
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_seqRecordSizeOffset, pvar_func_sseqRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    ...
    "mbboDirect", "permissive", "printf", "sel", "seq", "sseq", "state",
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_asynAiFloat64Average, *pvar_dset_devAidg535,
    *pvar_dset_devAoSoft, *pvar_dset_devAoSoftRaw,
    *pvar_dset_devAoSoftCallback, *pvar_dset_asynAoInt32,
    *pvar_dset_asynAoFloat64, *pvar_dset_devAodg535,
    ...
    *pvar_dset_asynBiUInt32Digital, *pvar_dset_devBidg535,
    ...
    *pvar_dset_asynBoUInt32Digital, *pvar_dset_devBodg535,
    ...
    *pvar_dset_asynMbbiUInt32Digital, *pvar_dset_devMbbidg535,
    ...
    *pvar_dset_devMbbodg535, *pvar_dset_devMbboDirectSoft,
    ...
    *pvar_dset_devSidg535, *pvar_dset_devSoSoft,
    *pvar_dset_devSoSoftCallback, *pvar_dset_devSoStdio,
    *pvar_dset_asynSoOctetWrite, *pvar_dset_devSodg535,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "devAidg535", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "asynAoInt32", "asynAoFloat64", "devAodg535",
    "asynRecordDevice", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "asynBiInt32", "asynBiUInt32Digital", "devBidg535",
    "devBoSoft", "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "asynBoInt32", "asynBoUInt32Digital", "devBodg535",
    ...
    "devLidg535", "devLoSoft", "devLoSoftCallback", "asynLoInt32",
    "asynLoUInt32Digital", "devLodg535", "devLsiSoft", "devLsiEnviron",
    "devLsoSoft", "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft",
    "devMbbiSoftRaw", "devMbbiSoftCallback", "asynMbbiInt32",
    "asynMbbiUInt32Digital", "devMbbidg535", "devMbbiDirectSoft",
    ...
    "devMbbodg535", "devMbboDirectSoft", "devMbboDirectSoftRaw",
    ...
    "asynSiOctetWriteRead", "asynSiOctetRead", "devSidg535", "devSoSoft",
    "devSoSoftCallback", "devSoStdio", "asynSoOctetWrite", "devSodg535",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAidg535, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_asynAoInt32,
    pvar_dset_asynAoFloat64, pvar_dset_devAodg535,
    pvar_dset_asynRecordDevice, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
    ...
    pvar_dset_devLoSoft, pvar_dset_devLoSoftCallback,
    pvar_dset_asynLoInt32, pvar_dset_asynLoUInt32Digital,
    pvar_dset_devLodg535, pvar_dset_devLsiSoft, pvar_dset_devLsiEnviron,
    ...
    pvar_dset_devMbbidg535, pvar_dset_devMbbiDirectSoft,
    ...
    pvar_dset_devSidg535, pvar_dset_devSoSoft,
    pvar_dset_devSoSoftCallback, pvar_dset_devSoStdio,
    pvar_dset_asynSoOctetWrite, pvar_dset_devSodg535, pvar_dset_devSASoft,
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_dbndInitialize, pvar_func_drvAsynCoherentSDGRegister,
    ...
    pvar_func_nigpibInterposeRegister, pvar_func_syncInitialize,
...
int delaygenApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/delaygen-R1-2-0";
...
/* delaygenApp_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"delaygenApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    delaygenApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
