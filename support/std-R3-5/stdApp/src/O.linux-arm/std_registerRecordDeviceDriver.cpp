...
static const char * const recordTypeNames[] = {
    ...
    "scaler", "sel", "seq", "state", "stringin", "stringout", "sub",
    "subArray", "throttle", "timestamp", "waveform"
};
...
static const char * const deviceSupportNames[] = {
    ...
    "devScalerAsyn", "devSiSoft", "devSiSoftCallback", "devTimestampSI",
...
epicsShareExtern reg_func pvar_func_Scaler974Register,
    ...
    pvar_func_pvHistoryRegister, pvar_func_rsrvRegistrar,
