...
epicsShareExtern rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_scalerRSET, *pvar_rset_selRSET, *pvar_rset_seqRSET,
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_printfRecordSizeOffset, pvar_func_scalerRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    ...
    "mbbo", "mbboDirect", "permissive", "printf", "scaler", "sel", "seq",
    "state", "stringin", "stringout", "sub", "subArray", "throttle",
    "timestamp", "waveform"
};
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_asynSiOctetRead, *pvar_dset_devSiTodString,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "devAiTodSeconds", "devAoSoft",
    ...
    "devEpidSoftCB", "devEpidFast", "devEventSoft", "devHistogramSoft",
    ...
    "devPrintfSoftCallback", "devPrintfStdio", "devScalerAsyn",
    "devSiSoft", "devSiSoftCallback", "devTimestampSI",
    "devSiGeneralTime", "devSiEnviron", "asynSiOctetCmdResponse",
    "asynSiOctetWriteRead", "asynSiOctetRead", "devSiTodString",
...
epicsShareExtern reg_func pvar_func_Scaler974Register,
    ...
    pvar_func_dbndInitialize, pvar_func_delayDoRegistrar,
    ...
    pvar_func_drvScalerSoftRegister, pvar_func_femtoRegistrar,
    pvar_func_pvHistoryRegister, pvar_func_syncInitialize,
...
int std_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/vasu/synApps/support/std-R3-5";
...
/* std_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"std_registerRecordDeviceDriver", 1, rrddArgs};
