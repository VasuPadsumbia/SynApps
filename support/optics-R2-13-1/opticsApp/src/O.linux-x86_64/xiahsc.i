...
ss xiahsc {
  ...
  state comm_error {
    when (init || !s_sevr || delay((10 * 60.0))) {
      if (xiahscDebug >= 20) { printf("(%s,%d): ", "../xiahsc.st", 400); printf("comm_error: init=%d  s_sevr=%d",init,s_sevr); printf("\n"); }
      init_delay = 1.0;
      s_sevr = 0;
      {init = (1); pvPut(init);};
    } state init
...
# 423 "../xiahsc.st"
   ...
   {strcpy(errMsg, "H ID not a valid HSC ID"); pvPut(errMsg);};
    ...
    when (!init && delay(0.1)) {
      ...
      { if (!s_sevr) { sprintf (hsc_command, "!%s %s", "ALL", "K"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 532); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (1); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } };
      epicsThreadSleep(.1);
# 542 "../xiahsc.st"
      error = 0;
      { efClear (s_ainp_mon); hsc_timeout = 1; { if (!s_sevr) { sprintf (hsc_command, "!%s %s", hID, "R 1"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 543); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (0); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }; { if (!s_sevr) { for (i = 15; i; i--) { if (efTest (s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(.02); }; if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 543); printf("WAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>",hsc_command); printf("\n"); }; } else { strcpy(hsc_response, s_ainp); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 543); printf("WAIT_HSC_RESPONSE: <%s> -> NORD=%d  AINP=%s",hsc_command,s_nord,hsc_response); printf("\n"); }; }; } }; };
      if (sscanf (hsc_response, "%*s %*s %d", &hOuterLimit) != 1) {
  error++;
 if (xiahscDebug >= 5) { printf("(%s,%d): ", "../xiahsc.st", 546); printf("Could not read horizontal outer limit"); printf("\n"); };
      }
      { efClear (s_ainp_mon); hsc_timeout = 1; { if (!s_sevr) { sprintf (hsc_command, "!%s %s", hID, "R 2"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 548); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (0); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }; { if (!s_sevr) { for (i = 15; i; i--) { if (efTest (s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(.02); }; if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 548); printf("WAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>",hsc_command); printf("\n"); }; } else { strcpy(hsc_response, s_ainp); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 548); printf("WAIT_HSC_RESPONSE: <%s> -> NORD=%d  AINP=%s",hsc_command,s_nord,hsc_response); printf("\n"); }; }; } }; };
      if (sscanf (hsc_response, "%*s %*s %d", &hOrigin) != 1) {
  error++;
 if (xiahscDebug >= 5) { printf("(%s,%d): ", "../xiahsc.st", 551); printf("Could not read horizontal origin position"); printf("\n"); };
      }
 ...
 {h0_lo = ((r_lo - l_hi)/2); pvPut(h0_lo);};
      ...
      error = 0;
      { efClear (s_ainp_mon); hsc_timeout = 1; { if (!s_sevr) { sprintf (hsc_command, "!%s %s", vID, "R 1"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 578); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (0); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }; { if (!s_sevr) { for (i = 15; i; i--) { if (efTest (s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(.02); }; if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 578); printf("WAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>",hsc_command); printf("\n"); }; } else { strcpy(hsc_response, s_ainp); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 578); printf("WAIT_HSC_RESPONSE: <%s> -> NORD=%d  AINP=%s",hsc_command,s_nord,hsc_response); printf("\n"); }; }; } }; };
      if (sscanf (hsc_response, "%*s %*s %d", &vOuterLimit)!= 1) {
        error++;
 if (xiahscDebug >= 5) { printf("(%s,%d): ", "../xiahsc.st", 581); printf("Could not read vertical outer limit"); printf("\n"); };
      }
      { efClear (s_ainp_mon); hsc_timeout = 1; { if (!s_sevr) { sprintf (hsc_command, "!%s %s", vID, "R 2"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 583); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (0); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }; { if (!s_sevr) { for (i = 15; i; i--) { if (efTest (s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(.02); }; if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 583); printf("WAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>",hsc_command); printf("\n"); }; } else { strcpy(hsc_response, s_ainp); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 583); printf("WAIT_HSC_RESPONSE: <%s> -> NORD=%d  AINP=%s",hsc_command,s_nord,hsc_response); printf("\n"); }; }; } }; };
      if (sscanf (hsc_response, "%*s %*s %d", &vOrigin)!= 1) {
        error++;
 if (xiahscDebug >= 5) { printf("(%s,%d): ", "../xiahsc.st", 586); printf("Could not read vertical origin position"); printf("\n"); };
      }
      if (!error) {
 ...
 {v0_lo = ((t_lo - b_hi)/2); pvPut(v0_lo);};
  ...
  state idle {
    ...
    when (efTest (stop_mon) && stop) {
      ...
      { if (!s_sevr) { sprintf (hsc_command, "!%s %s", "ALL", "K"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 636); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (1); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }
      epicsThreadSleep(.1);
      efClear (stop_mon);
      {locate = (1); pvPut(locate);};
    } state idle
    ...
    && delay (0.1)) {
      if (efTest (start_H_move)) {
        if (hBusy) {
          { if (!s_sevr) { sprintf (hsc_command, "!%s %s", hID, "K"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 659); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (1); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } };
          epicsThreadSleep(.1);
        } else {
          {hBusy = (1); pvPut(hBusy);};
        }
      ...
      if (efTest (start_V_move)) {
        if (vBusy) {
          { if (!s_sevr) { sprintf (hsc_command, "!%s %s", vID, "K"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 680); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (1); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } };
          epicsThreadSleep(.1);
        } else {
          {vBusy = (1); pvPut(vBusy);};
        }
      ...
      { if (!s_sevr) { sprintf (hsc_command, "!%s %s", word1, scratch); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 700); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (1); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } };
      epicsThreadSleep(.1);
      {locate = (1); pvPut(locate);};
    } state idle
...
# 714 "../xiahsc.st"
    ...
    when ( calibrate ) {
      ...
      { if (!s_sevr) { sprintf (hsc_command, "!%s %s", "ALL", "0 I"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 725); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (1); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }
      epicsThreadSleep(.1);
      {calibrate = (0); pvPut(calibrate);};
      {locate = (1); pvPut(locate);};
    } state idle
  ...
  state get_readback_positions {
    ...
    when ( ) {
      ...
      { efClear (s_ainp_mon); hsc_timeout = 1; { if (!s_sevr) { sprintf (hsc_command, "!%s %s", hID, "P"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 784); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (0); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }; { if (!s_sevr) { for (i = 15; i; i--) { if (efTest (s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(.02); }; if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 784); printf("WAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>",hsc_command); printf("\n"); }; } else { strcpy(hsc_response, s_ainp); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 784); printf("WAIT_HSC_RESPONSE: <%s> -> NORD=%d  AINP=%s",hsc_command,s_nord,hsc_response); printf("\n"); }; }; } }; };
      h_valid = validateResponse(hsc_command, hsc_response);
      if (xiahscDebug >= 2) { printf("(%s,%d): ", "../xiahsc.st", 786); printf("validateResponse (H): %i",h_valid); printf("\n"); };
      if (h_valid) {
   ...
   if (hBusy) {hBusy = (0); pvPut(hBusy);};
         ...
         if (sscanf (hsc_response, "%*s %*s %s", scratch) == 1) {
           if (xiahscDebug >= 5) { printf("(%s,%d): ", "../xiahsc.st", 813); printf("axis=%s, command=<%s>, response=%s","H",hsc_command,hsc_response); printf("\n"); };
     if (!strcmp (scratch, "BUSY;")) {
       if (!hBusy) {hBusy = (1); pvPut(hBusy);};
     } else {
             if (xiahscDebug >= 20) { printf("(%s,%d): ", "../xiahsc.st", 817); printf("could not understand %s",hsc_response); printf("\n"); };
     }
   }
      } else {
        if (xiahscDebug >= 2) { printf("(%s,%d): ", "../xiahsc.st", 821); printf("incorrect response:  %s",hsc_response); printf("\n"); };
      }




      { efClear (s_ainp_mon); hsc_timeout = 1; { if (!s_sevr) { sprintf (hsc_command, "!%s %s", vID, "P"); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 827); printf("WRITE_HSC: <%s>",hsc_command); printf("\n"); }; {s_scan = (0); pvPut(s_scan);}; {s_tmod = (0); pvPut(s_tmod);}; {strcpy(s_ieos, "\n"); pvPut(s_ieos);}; {strcpy(s_oeos, "\r"); pvPut(s_oeos);}; {strcpy(s_aout, hsc_command); pvPut(s_aout);}; } }; { if (!s_sevr) { for (i = 15; i; i--) { if (efTest (s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(.02); }; if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 827); printf("WAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>",hsc_command); printf("\n"); }; } else { strcpy(hsc_response, s_ainp); if (xiahscDebug >= 10) { printf("(%s,%d): ", "../xiahsc.st", 827); printf("WAIT_HSC_RESPONSE: <%s> -> NORD=%d  AINP=%s",hsc_command,s_nord,hsc_response); printf("\n"); }; }; } }; };
      v_valid = validateResponse(hsc_command, hsc_response);
      if (xiahscDebug >= 2) { printf("(%s,%d): ", "../xiahsc.st", 829); printf("validateResponse (V): %i",v_valid); printf("\n"); };
      if (v_valid) {
       if (sscanf (hsc_response, "%*s %*s %d %d", &pos_a, &pos_b) == 2) {
   ...
   if (vBusy) {vBusy = (0); pvPut(vBusy);};
         ...
         if (sscanf (hsc_response, "%*s %*s %s", scratch) == 1) {
           if (xiahscDebug >= 5) { printf("(%s,%d): ", "../xiahsc.st", 856); printf("axis=%s, command=<%s>, response=%s","V",hsc_command,hsc_response); printf("\n"); };
     if (!strcmp (scratch, "BUSY;")) {
       if (!vBusy) {vBusy = (1); pvPut(vBusy);};
     } else {
             if (xiahscDebug >= 20) { printf("(%s,%d): ", "../xiahsc.st", 860); printf("could not understand %s",hsc_response); printf("\n"); };
     }
   }
      } else {
          if (xiahscDebug >= 2) { printf("(%s,%d): ", "../xiahsc.st", 864); printf("incorrect response:  %s",hsc_response); printf("\n"); };
      }
