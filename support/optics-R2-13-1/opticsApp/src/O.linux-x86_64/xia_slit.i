...
ss xiahsc {
  ...
  state comm_error {
    when (init || !s_sevr || delay((10*60.0))) {
      if (debug_flag >= 20) { printf("(%s,%d): ","../xia_slit.st",642); printf("comm_error: init=%d  s_sevr=%d",init,s_sevr); printf("\n"); }
      init_delay = 1.0;
      s_sevr = 0;
      { init = ( 1 ); pvPut(init,SYNC); };
    } state init
  ...
  state init {
    ...
    when (!init && delay(0.1)) {
      ...
      { sprintf(hsc_command, "!%s %s","ALL",("K")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 769, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
      epicsThreadSleep(.1);
      { sprintf(hsc_command, "!%s %s","ALL",("P")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 771, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
      epicsThreadSleep(.1);
      ainp_fifo_read = 0;
      ainp_fifo_write = 0;
      while (!s_sevr) {
        { { s_tmod = ( (2) ); pvPut(s_tmod,SYNC); }; efClear(s_ainp_mon); { s_proc = ( 1 ); pvPut(s_proc,SYNC); }; for (i = 0; i <= (30); i++) { if (efTest(s_ainp_mon)) { if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 776, SNLtaskName, 10);; printf("%s\n", "READ_HSC: got a message."); epicsThreadSleep(0.01); }; break; } epicsThreadSleep(0.02); } };
        { if (efTest(s_ainp_mon)) { strcpy(ainp_fifo[ainp_fifo_read++], s_ainp); { if ((ainp_fifo_read) >= 40) (ainp_fifo_read) = 0; }; delta = ainp_fifo_read-ainp_fifo_write; if (delta < 0) delta += 40; if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",777); printf("FIFO_IN: adding msg %d:\n ->'%s'",delta,s_ainp); printf("\n"); }; } };
      }
    } state init_limits
  }
  ...
  state init_limits {
    when () {
      ...
      error = 0;
      { { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",hID,("R 5")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 791, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 791, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",791); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; }; if (sscanf(hsc_response,"%*s %*s %d",&hStepDelay) == 1) { if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",791); printf("%s step delay %d",hID,hStepDelay); printf("\n"); }; pvPut(hStepDelay,SYNC); } else { ++error; if (debug_flag >= 1) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 791, SNLtaskName, 1);; printf("%s step delay format error", hID); printf("\n"); epicsThreadSleep(0.01); }; } };
      { { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",hID,("R 6")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 792, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 792, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",792); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; }; if (sscanf(hsc_response,"%*s %*s %d",&hGearBacklash) == 1) { if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",792); printf("%s backlash %d",hID,hGearBacklash); printf("\n"); }; pvPut(hGearBacklash,SYNC); } else { ++error; if (debug_flag >= 1) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 792, SNLtaskName, 1);; printf("%s backlash format error", hID); printf("\n"); epicsThreadSleep(0.01); }; } };
      { { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",hID,("R 7")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 793, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 793, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",793); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; }; if( sscanf(hsc_response,"%*s %*s %d",&hCSW) == 1 ) { if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",793); printf("%s cntrl word data %d",hID,hCSW); printf("\n"); }; { hStPwr = ( ((0x03) & hCSW) ); pvPut(hStPwr,SYNC); }; { hStLmts = ( (((0x04) & hCSW)?1:0) ); pvPut(hStLmts,SYNC); }; { hStBan = ( (((0x08) & hCSW)?1:0) ); pvPut(hStBan,SYNC); }; { hStEcho = ( (((0x10) & hCSW)?1:0) ); pvPut(hStEcho,SYNC); }; { hStLock = ( (((0x20) & hCSW)?1:0) ); pvPut(hStLock,SYNC); }; { hStAlias = ( (((0x40) & hCSW)?1:0) ); pvPut(hStAlias,SYNC); }; { hStText = ( (((0x80) & hCSW)?1:0) ); pvPut(hStText,SYNC); }; } else { ++error; if (debug_flag >= 1) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 793, SNLtaskName, 1);; printf("%s cntrl word format error", hID); printf("\n"); epicsThreadSleep(0.01); }; } };

      { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",hID,("R 1")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 795, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 795, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",795); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; };
      ...
      {
        error++;
        if (debug_flag >= 5) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 803, SNLtaskName, 5);; printf("%s\n", "Could not read horizontal outer limit"); epicsThreadSleep(0.01); };
      }
      { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",hID,("R 2")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 805, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 805, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",805); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; };
      ...
      {
        error++;
        if (debug_flag >= 5) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 813, SNLtaskName, 5);; printf("%s\n", "Could not read horizontal origin position"); epicsThreadSleep(0.01); };
      }
      if (!error) {
      ...
      error = 0;
      { { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",vID,("R 7")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 835, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 835, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",835); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; }; if( sscanf(hsc_response,"%*s %*s %d",&vCSW) == 1 ) { if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",835); printf("%s cntrl word data %d",vID,vCSW); printf("\n"); }; { vStPwr = ( ((0x03) & vCSW) ); pvPut(vStPwr,SYNC); }; { vStLmts = ( (((0x04) & vCSW)?1:0) ); pvPut(vStLmts,SYNC); }; { vStBan = ( (((0x08) & vCSW)?1:0) ); pvPut(vStBan,SYNC); }; { vStEcho = ( (((0x10) & vCSW)?1:0) ); pvPut(vStEcho,SYNC); }; { vStLock = ( (((0x20) & vCSW)?1:0) ); pvPut(vStLock,SYNC); }; { vStAlias = ( (((0x40) & vCSW)?1:0) ); pvPut(vStAlias,SYNC); }; { vStText = ( (((0x80) & vCSW)?1:0) ); pvPut(vStText,SYNC); }; } else { ++error; if (debug_flag >= 1) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 835, SNLtaskName, 1);; printf("%s cntrl word format error", vID); printf("\n"); epicsThreadSleep(0.01); }; } };
      { { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",vID,("R 6")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 836, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 836, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",836); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; }; if (sscanf(hsc_response,"%*s %*s %d",&vGearBacklash) == 1) { if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",836); printf("%s backlash %d",vID,vGearBacklash); printf("\n"); }; pvPut(vGearBacklash,SYNC); } else { ++error; if (debug_flag >= 1) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 836, SNLtaskName, 1);; printf("%s backlash format error", vID); printf("\n"); epicsThreadSleep(0.01); }; } };
      { { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",vID,("R 5")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 837, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 837, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",837); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; }; if (sscanf(hsc_response,"%*s %*s %d",&vStepDelay) == 1) { if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",837); printf("%s step delay %d",vID,vStepDelay); printf("\n"); }; pvPut(vStepDelay,SYNC); } else { ++error; if (debug_flag >= 1) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 837, SNLtaskName, 1);; printf("%s step delay format error", vID); printf("\n"); epicsThreadSleep(0.01); }; } };

      { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",vID,("R 1")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 839, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 839, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",839); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; };
      ...
      {
        error++;
        if (debug_flag >= 5) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 847, SNLtaskName, 5);; printf("%s\n", "Could not read vertical outer limit"); epicsThreadSleep(0.01); };
      }

      { efClear(s_ainp_mon); hsc_timeout = 1; { sprintf(hsc_command, "!%s %s",vID,("R 2")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 850, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (0) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }; { for (i = (30); i; i--) { if (efTest(s_ainp_mon)) { hsc_timeout = 0; break; } epicsThreadSleep(0.02); } if (hsc_timeout == 1) { strcpy(hsc_response, ""); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 850, SNLtaskName, 10);; printf("\nWAIT_HSC_RESPONSE: <%s> -> <<< TIMEOUT >>>", s_tinp); printf("\n"); epicsThreadSleep(0.01); }; } else { strcpy(hsc_response, s_ainp); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",850); printf("\nWAIT_HSC_RESPONSE: <%s> -> NORD=%d  TINP=%s",hsc_command,s_nord,s_tinp); printf("\n"); }; } }; };
      ...
      {
        error++;
        if (debug_flag >= 5) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 858, SNLtaskName, 5);; printf("%s\n", "Could not read vertical origin position"); epicsThreadSleep(0.01); };
      }
      if (!error) {
  ...
  state idle {
    ...
    when (efTest (stop_mon) && stop) {
      { sprintf(hsc_command, "!%s %s","ALL",("K")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 904, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
      epicsThreadSleep(.1);
      efClear (stop_mon);
    } state idle
    ...
    when ( efTest (l_event_mon) ) {
      if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 913, SNLtaskName, 2);; printf("efTest(l_event_mon) -> premove, l=%f", l); printf("\n"); epicsThreadSleep(0.01); };
    } state premove
    ...
    || efTest (v0_event_mon) || efTest (width_event_mon) ) {
      if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 920, SNLtaskName, 2);; printf("%s\n", "efTest() -> premove"); epicsThreadSleep(0.01); };
    } state premove
    ...
    when (efTest (start_H_move)) {
      if (hBusy) {
        if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 928, SNLtaskName, 2);; printf("%s\n", "efTest(start_H_move) and hBusy"); epicsThreadSleep(0.01); };
        { sprintf(hsc_command, "!%s %s",hID,("K")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 929, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
        epicsThreadSleep(.5);
      } else {
      ...
      while (!s_sevr) {
        { { s_tmod = ( (2) ); pvPut(s_tmod,SYNC); }; efClear(s_ainp_mon); { s_proc = ( 1 ); pvPut(s_proc,SYNC); }; for (i = 0; i <= (30); i++) { if (efTest(s_ainp_mon)) { if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 944, SNLtaskName, 10);; printf("%s\n", "READ_HSC: got a message."); epicsThreadSleep(0.01); }; break; } epicsThreadSleep(0.02); } };

        sscanf(s_ainp, "%%%s", id);
        if (!strcmp(id, hID)) {
          if (debug_flag >= 2) { printf("(%s,%d): ","../xia_slit.st",948); printf("discarding hID message '%s' id='%s'\n",s_tinp,id); printf("\n"); };
        } else {
          { if (efTest(s_ainp_mon)) { strcpy(ainp_fifo[ainp_fifo_read++], s_ainp); { if ((ainp_fifo_read) >= 40) (ainp_fifo_read) = 0; }; delta = ainp_fifo_read-ainp_fifo_write; if (delta < 0) delta += 40; if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",950); printf("FIFO_IN: adding msg %d:\n ->'%s'",delta,s_ainp); printf("\n"); }; } };
        }
      }
      pos_a = ((pos_ag)*((400.0))+(0.5)+(hOrigin));
      pos_b = ((pos_bg)*((400.0))+(0.5)+(hOrigin));
      sprintf (scratch, "M %d %d", pos_a, pos_b);
      if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 956, SNLtaskName, 2);; printf("%s\n", "start_H_move: writing to motor"); epicsThreadSleep(0.01); };
      { sprintf(hsc_command, "!%s %s",hID,scratch); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 957, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
    } state idle

    when (efTest (start_V_move)) {
      if (vBusy) {
        { sprintf(hsc_command, "!%s %s",vID,("K")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 962, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
        epicsThreadSleep(.5);
      } else {
      ...
      while (!s_sevr) {
        { { s_tmod = ( (2) ); pvPut(s_tmod,SYNC); }; efClear(s_ainp_mon); { s_proc = ( 1 ); pvPut(s_proc,SYNC); }; for (i = 0; i <= (30); i++) { if (efTest(s_ainp_mon)) { if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 977, SNLtaskName, 10);; printf("%s\n", "READ_HSC: got a message."); epicsThreadSleep(0.01); }; break; } epicsThreadSleep(0.02); } };

        sscanf(s_ainp, "%%%s", id);
        if (!strcmp(id, vID)) {
          if (debug_flag >= 2) { printf("(%s,%d): ","../xia_slit.st",981); printf("discarding vID message '%s' id='%s'\n",s_tinp,id); printf("\n"); };
        } else {
          { if (efTest(s_ainp_mon)) { strcpy(ainp_fifo[ainp_fifo_read++], s_ainp); { if ((ainp_fifo_read) >= 40) (ainp_fifo_read) = 0; }; delta = ainp_fifo_read-ainp_fifo_write; if (delta < 0) delta += 40; if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",983); printf("FIFO_IN: adding msg %d:\n ->'%s'",delta,s_ainp); printf("\n"); }; } };
        }
      }
      pos_a = ((pos_ag)*((400.0))+(0.5)+(vOrigin));
      pos_b = ((pos_bg)*((400.0))+(0.5)+(vOrigin));
      sprintf (scratch, "M %d %d", pos_a, pos_b);
      { sprintf(hsc_command, "!%s %s",vID,scratch); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 989, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
    } state idle
    ...
    when (locate) {
      ...
      { sprintf(hsc_command, "!%s %s","ALL",("P")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1003, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; };
      epicsThreadSleep(.1);
      while (!s_sevr) {
        if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1006, SNLtaskName, 10);; printf("%s\n", "locate: calling READ_HSC"); epicsThreadSleep(0.01); };
        { { s_tmod = ( (2) ); pvPut(s_tmod,SYNC); }; efClear(s_ainp_mon); { s_proc = ( 1 ); pvPut(s_proc,SYNC); }; for (i = 0; i <= (30); i++) { if (efTest(s_ainp_mon)) { if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1007, SNLtaskName, 10);; printf("%s\n", "READ_HSC: got a message."); epicsThreadSleep(0.01); }; break; } epicsThreadSleep(0.02); } };
        if (!s_sevr) { if (efTest(s_ainp_mon)) { strcpy(ainp_fifo[ainp_fifo_read++], s_ainp); { if ((ainp_fifo_read) >= 40) (ainp_fifo_read) = 0; }; delta = ainp_fifo_read-ainp_fifo_write; if (delta < 0) delta += 40; if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",1008); printf("FIFO_IN: adding msg %d:\n ->'%s'",delta,s_ainp); printf("\n"); }; } };
      }
      if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1010, SNLtaskName, 10);; printf("%s\n", "locate: s_sevr = TRUE"); epicsThreadSleep(0.01); };
    } state idle
    ...
    when (calibrate) {
      ...
      { sprintf(hsc_command, "!%s %s","ALL",("0 I")); if (debug_flag >= 10) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1019, SNLtaskName, 10);; printf("WRITE_HSC: <%s>", hsc_command); printf("\n"); epicsThreadSleep(0.01); }; { s_scan = ( (0) ); pvPut(s_scan,SYNC); }; { s_tmod = ( (1) ); pvPut(s_tmod,SYNC); }; { strcpy(s_ieos,("\r\n")); pvPut(s_ieos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_oeos,("\r")); pvPut(s_oeos,SYNC); epicsThreadSleep(0.01); }; { strcpy(s_aout,hsc_command); pvPut(s_aout,SYNC); epicsThreadSleep(0.01); }; }
      epicsThreadSleep(.1);
      { calibrate = ( (0) ); pvPut(calibrate,SYNC); };
      { locate = ( 1 ); pvPut(locate,SYNC); };
    } state idle
    ...
    when (ainp_fifo_read != ainp_fifo_write) {
      { delta = ainp_fifo_read-ainp_fifo_write; if (delta < 0) delta += 40; strcpy(scratch, ainp_fifo[ainp_fifo_write++]); if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",1030); printf("FIFO_OUT: got message %d:\n ->'%s'",delta,scratch); printf("\n"); }; { if ((ainp_fifo_write) >= 40) (ainp_fifo_write) = 0; }; };
    ...
    when (efTest (new_H_RB)) {
      ...
      if (debug_flag >= 2) { printf("(%s,%d): ","../xia_slit.st",1050); printf("efTest(new_H_RB)==1; h_Busy|hBusy=%d, l=%f,l_RB=%f",h_Busy|hBusy,l,l_RB); printf("\n"); };
      if (!hBusy && !h_Busy) {
    ...
    when (delay ((30))) {
      { locate = ( 1 ); pvPut(locate,SYNC); };
      if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1094, SNLtaskName, 2);; printf("%s\n", "IDLE POLL"); epicsThreadSleep(0.01); };
    } state idle
  }
    ...
    when () {
      ...
      if (efTest (l_event_mon) || efTest (r_event_mon) ||
        ...
        if (error) {
          ...
          efSet (start_H_move);
          if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1178, SNLtaskName, 2);; printf("%s\n", "premove: efSet(start_H_move)"); epicsThreadSleep(0.01); };
          if (efTest (l_event_mon) || efTest (r_event_mon)) {
  ...
  state process_response {
    entry {
      if (debug_flag >= 5) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1239, SNLtaskName, 5);; printf("process_response:entry numWords=%d", numWords); printf("\n"); epicsThreadSleep(0.01); };
    }
    ...
    when ( (numWords >= 2) && (!strcmp(word2, "ERROR;")) ) {
      ...
      if (!strcmp(word1, hID)) {
        if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1264, SNLtaskName, 2);; printf("'%s' reported an error: ->h_BusyOff", hID); printf("\n"); epicsThreadSleep(0.01); };
        { h_BusyOff = ( 0 ); pvPut(h_BusyOff,SYNC); };
        h_isMoving = 0;
      } else if (!strcmp(word1, vID)) {
        if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1268, SNLtaskName, 2);; printf("'%s' reported an error: ->v_BusyOff", vID); printf("\n"); epicsThreadSleep(0.01); };
        { v_BusyOff = ( 0 ); pvPut(v_BusyOff,SYNC); };
        v_isMoving = 0;
      }
    } state idle
    ...
    when ( (numWords == 4) && (!strcmp(word4, "DONE;")) ) {
      ...
      sscanf (word2, "%d", &pos_a);
      sscanf (word3, "%d", &pos_b);
      if (error) {
        { error = ( 0 ); pvPut(error,SYNC); };
        { strcpy(errMsg,"no error"); pvPut(errMsg,SYNC); epicsThreadSleep(0.01); };
      }
      ...
      if (!strcmp(id, hID)) {
        if (debug_flag >= 5) { printf("(%s,%d): ","../xia_slit.st",1302); printf("hDONE: pos_a = %d, pos_b = %d",pos_a,pos_b); printf("\n"); };
        pos_ag = (((pos_a)-(hOrigin))/((400.0)) );
        pos_bg = (((pos_b)-(hOrigin))/((400.0)) );
        h_isMoving = 0;
        l_raw = ((l)*((400.0))+(0.5)+(hOrigin));
        r_raw = ((r)*((400.0))+(0.5)+(hOrigin));
        if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",1308); printf("hRaw; l=%d, r=%d",l_raw,r_raw); printf("\n"); };
        if (hOrient == (0)) {
        ...
        if (debug_flag >= 5) { printf("(%s,%d): ","../xia_slit.st",1315); printf("vDONE: pos_a = %d, pos_b = %d",pos_a,pos_b); printf("\n"); };
        pos_ag = (((pos_a)-(vOrigin))/((400.0)) );
        pos_bg = (((pos_b)-(vOrigin))/((400.0)) );
        v_isMoving = 0;
        t_raw = ((t)*((400.0))+(0.5)+(vOrigin));
        b_raw = ((b)*((400.0))+(0.5)+(vOrigin));
        if (debug_flag >= 10) { printf("(%s,%d): ","../xia_slit.st",1321); printf("vRaw; t=%d, b=%d",t_raw,b_raw); printf("\n"); };
        if (vOrient == (0)) {
    ...
    when ( (numWords == 5) && (!strcmp(word2, "OK")) ) {
      ...
      sscanf (word3, "%d", &pos_a);
      sscanf (word4, "%d", &pos_b);
      if (error) {
        { error = ( 0 ); pvPut(error,SYNC); };
        { strcpy(errMsg,"no error"); pvPut(errMsg,SYNC); epicsThreadSleep(0.01); };
      }
  ...
  state update_positions {
    when () {
      ...
      if (!strcmp(id, hID)) {
        ...
        if (debug_flag >= 2) { printf("<%s,%d,%s,%d> ", "../xia_slit.st", 1370, SNLtaskName, 2);; printf("%s\n", "update_positions: efSet(new_H_RB)"); epicsThreadSleep(0.01); };
        efSet (new_H_RB);
        { hBusy = ( (0) ); pvPut(hBusy,SYNC); };
