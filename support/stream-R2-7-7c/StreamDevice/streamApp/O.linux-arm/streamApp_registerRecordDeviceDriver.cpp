...
static const char * const deviceSupportNames[] = {
    ...
    "devTimestampAI", "devAiGeneralTime", "devaiStream", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "devaoStream", "devBiSoft",
    ...
    "devLiSoftCallback", "devLiGeneralTime", "devlonginStream",
    "devLoSoft", "devLoSoftCallback", "devlongoutStream", "devLsiSoft",
    ...
    "devMbbiDirectSoftCallback", "devmbbiDirectStream", "devMbboSoft",
    "devMbboSoftRaw", "devMbboSoftCallback", "devmbboStream",
    "devMbboDirectSoft", "devMbboDirectSoftRaw",
    "devMbboDirectSoftCallback", "devmbboDirectStream", "devPrintfSoft",
...
int streamApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/vasu/synApps/support/stream-R2-7-7c";
