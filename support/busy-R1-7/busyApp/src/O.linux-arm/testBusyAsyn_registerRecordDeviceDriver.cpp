...
/* Generated from ../O.Common/testBusyAsyn.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_dbrestoreRegister, pvar_func_rsrvRegistrar,
    pvar_func_save_restoreRegister, pvar_func_syncInitialize,
    pvar_func_testBusyAsynRegister, pvar_func_tsInitialize;
...
int testBusyAsyn_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/busy-R1-7";
    ...
    pvar_func_testBusyAsynRegister();
    pvar_func_tsInitialize();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* testBusyAsyn_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testBusyAsyn_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testBusyAsyn_registerRecordDeviceDriver(*iocshPpdbbase);
}
