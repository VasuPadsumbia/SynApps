...
/* Generated from ../O.Common/scriptioc.dbd */
...
epicsShareExtern rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_luascriptRSET, *pvar_rset_mbbiRSET,
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devLuaAi,
    *pvar_dset_devAoSoft, *pvar_dset_devAoSoftRaw,
    *pvar_dset_devAoSoftCallback, *pvar_dset_devLuaAo,
    *pvar_dset_devBiSoft, *pvar_dset_devBiSoftRaw,
    *pvar_dset_devBiSoftCallback, *pvar_dset_devBiDbState,
    *pvar_dset_devLuaBi, *pvar_dset_devBoSoft, *pvar_dset_devBoSoftRaw,
    *pvar_dset_devBoSoftCallback, *pvar_dset_devBoGeneralTime,
    *pvar_dset_devBoDbState, *pvar_dset_devLuaBo,
    ...
    *pvar_dset_devLiGeneralTime, *pvar_dset_devLuaLongin,
    *pvar_dset_devLoSoft, *pvar_dset_devLoSoftCallback,
    *pvar_dset_devLuaLongout, *pvar_dset_devLsiSoft,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devLuaStringin,
    *pvar_dset_devSoSoft, *pvar_dset_devSoSoftCallback,
    *pvar_dset_devSoStdio, *pvar_dset_devLuaStringout,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiSoftCallback", "devTimestampAI", "devAiGeneralTime", "devLuaAi",
    "devAoSoft", "devAoSoftRaw", "devAoSoftCallback", "devLuaAo",
    "devBiSoft", "devBiSoftRaw", "devBiSoftCallback", "devBiDbState",
    "devLuaBi", "devBoSoft", "devBoSoftRaw", "devBoSoftCallback",
    "devBoGeneralTime", "devBoDbState", "devLuaBo", "devCalcoutSoft",
    "devCalcoutSoftCallback", "devEventSoft", "devHistogramSoft",
    "devLiSoft", "devLiSoftCallback", "devLiGeneralTime", "devLuaLongin",
    "devLoSoft", "devLoSoftCallback", "devLuaLongout", "devLsiSoft",
    "devLsiEnviron", "devLsoSoft", "devLsoSoftCallback", "devLsoStdio",
    "devLuaSoft", "devMbbiSoft", "devMbbiSoftRaw", "devMbbiSoftCallback",
    "devLuaMbbi", "devMbbiDirectSoft", "devMbbiDirectSoftRaw",
    "devMbbiDirectSoftCallback", "devMbboSoft", "devMbboSoftRaw",
    "devMbboSoftCallback", "devLuaMbbo", "devMbboDirectSoft",
    ...
    "devSiEnviron", "devLuaStringin", "devSoSoft", "devSoSoftCallback",
    "devSoStdio", "devLuaStringout", "devSASoft", "devWfSoft"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devLuaAi, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_devLuaAo, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
    pvar_dset_devBiDbState, pvar_dset_devLuaBi, pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw, pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime, pvar_dset_devBoDbState,
    pvar_dset_devLuaBo, pvar_dset_devCalcoutSoft,
    ...
    pvar_dset_devLuaLongin, pvar_dset_devLoSoft,
    pvar_dset_devLoSoftCallback, pvar_dset_devLuaLongout,
    ...
    pvar_dset_devMbbiSoftCallback, pvar_dset_devLuaMbbi,
    ...
    pvar_dset_devLuaMbbo, pvar_dset_devMbboDirectSoft,
    ...
    pvar_dset_devLuaStringin, pvar_dset_devSoSoft,
    pvar_dset_devSoSoftCallback, pvar_dset_devSoStdio,
    pvar_dset_devLuaStringout, pvar_dset_devSASoft, pvar_dset_devWfSoft
};
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_luashRegister, pvar_func_syncInitialize,
...
int scriptioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/lua-R1-2-2";
...
/* scriptioc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"scriptioc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    scriptioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
