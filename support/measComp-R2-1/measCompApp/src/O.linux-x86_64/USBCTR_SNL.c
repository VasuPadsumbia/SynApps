...
# line 41 "../USBCTR_SNL.st"
	int SNL_Connected;
# line 42 "../USBCTR_SNL.st"
	int AsynDebug;
# line 45 "../USBCTR_SNL.st"
	int Acquiring;
};
...
static void seqg_action_mca_control_0_init(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 50 "../USBCTR_SNL.st"
			seqg_var->prefix = seq_macValueGet(seqg_env, "P");
# line 51 "../USBCTR_SNL.st"
...
# line 54 "../USBCTR_SNL.st"
			if ((seqg_var->numCounters <= 0) || (seqg_var->numCounters > 8))
			{
...
static void seqg_action_mca_control_0_monitor_changes(SS_ID seqg_env, int seqg_trn, int *seqg_pnst)
{
	...
	case 0:
		{
# line 85 "../USBCTR_SNL.st"
			printf("USBCTR: Not all channels connected.\n");
		}
		return;
	case 1:
		{
# line 89 "../USBCTR_SNL.st"
...
# line 95 "../USBCTR_SNL.st"
			seq_pvPutTmo(seqg_env, 8/*ReadArrays*/, DEFAULT, DEFAULT_TIMEOUT);
		}
		return;
	case 2:
		{
...
# line 109 "../USBCTR_SNL.st"
				seq_pvPutTmo(seqg_env, 12/*Acquiring*/, DEFAULT, DEFAULT_TIMEOUT);
			}
		}
		return;
	}
...
static seqChan seqg_chans[] = {
	...
	{"{P}DoReadAll", offsetof(struct seqg_vars, ReadArrays), "ReadArrays", P_INT, 1, 11, 1, 1, 0, 0},
	{"{P}HardwareAcquiring", offsetof(struct seqg_vars, HardwareAcquiring), "HardwareAcquiring", P_INT, 1, 12, 2, 1, 0, 0},
	{"{P}SNL_Connected", offsetof(struct seqg_vars, SNL_Connected), "SNL_Connected", P_INT, 1, 13, 0, 0, 0, 0},
	{"{P}Asyn.TB1", offsetof(struct seqg_vars, AsynDebug), "AsynDebug", P_INT, 1, 14, 0, 1, 0, 0},
	{"{P}Acquiring", offsetof(struct seqg_vars, Acquiring), "Acquiring", P_INT, 1, 15, 0, 0, 0, 0},
};
