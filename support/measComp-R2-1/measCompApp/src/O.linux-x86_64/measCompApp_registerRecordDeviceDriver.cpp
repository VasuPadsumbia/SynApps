...
/* Generated from ../O.Common/measCompApp.dbd */
...
epicsShareExtern rset *pvar_rset_aSubRSET, *pvar_rset_aaiRSET,
    ...
    *pvar_rset_mbboRSET, *pvar_rset_mbboDirectRSET, *pvar_rset_mcaRSET,
...
epicsShareExtern rso_func pvar_func_aSubRecordSizeOffset,
    ...
    pvar_func_throttleRecordSizeOffset,
...
static const char * const recordTypeNames[] = {
    ...
    "busy", "calc", "calcout", "compress", "dfanout", "epid", "event",
    "fanout", "histogram", "longin", "longout", "lsi", "lso", "mbbi",
    "mbbiDirect", "mbbo", "mbboDirect", "mca", "permissive", "printf",
    "scalcout", "scaler", "scanparm", "sel", "seq", "sscan", "sseq",
    "state", "stringin", "stringout", "sub", "subArray", "swait",
    "throttle", "timestamp", "transform", "waveform"
};
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiTodSeconds, *pvar_dset_devAoSoft,
    ...
    *pvar_dset_devsCalcoutSoft, *pvar_dset_devScalerAsyn,
    ...
    *pvar_dset_devSiTodString, *pvar_dset_devSoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64", "asynAiFloat64Average", "devAiTodSeconds",
    ...
    "devEpidSoft", "devEpidSoftCB", "devEpidFast", "devEventSoft",
    ...
    "devMCA_soft", "devMcaAsyn", "devPrintfSoft", "devPrintfSoftCallback",
    "devPrintfStdio", "devsCalcoutSoft", "devScalerAsyn", "devSiSoft",
    "devSiSoftCallback", "devTimestampSI", "devSiGeneralTime",
    "devSiEnviron", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
    "asynSiOctetRead", "devSiTodString", "devSoSoft", "devSoSoftCallback",
    "devSoStdio", "asynSoOctetWrite", "devSASoft", "devSWaitIoEvent",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynAiFloat64Average, pvar_dset_devAiTodSeconds,
...
epicsShareExtern reg_func pvar_func_Scaler974Register,
    pvar_func_USBCTR_SNLRegistrar, pvar_func_aCalcMonitorMemRegister,
    ...
    pvar_func_dbrestoreRegister, pvar_func_delayDoRegistrar,
    pvar_func_doAfterIocInitRegistrar, pvar_func_drvC9513Register,
    pvar_func_drvMultiFunctionRegister, pvar_func_drvScalerSoftRegister,
    pvar_func_drvUSBCTRRegister, pvar_func_fastSweepRegister,
    pvar_func_femtoRegistrar, pvar_func_interpRegister,
    pvar_func_pvHistoryRegister, pvar_func_saveDataRegistrar,
...
int measCompApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/measComp-R2-1";
    ...
    pvar_func_drvC9513Register();
    pvar_func_drvMultiFunctionRegister();
    pvar_func_drvScalerSoftRegister();
    pvar_func_drvUSBCTRRegister();
...
/* measCompApp_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"measCompApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    measCompApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
