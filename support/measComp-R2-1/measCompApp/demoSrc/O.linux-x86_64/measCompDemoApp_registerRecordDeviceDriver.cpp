...
/* Generated from ../O.Common/measCompDemoApp.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_dbndInitialize, pvar_func_drvUSB1608GRegister,
...
int measCompDemoApp_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* measCompDemoApp_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"measCompDemoApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    measCompDemoApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
