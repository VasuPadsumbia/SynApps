...
/* Generated from ../O.Common/quadEMTestApp.dbd */
...
epicsShareExtern reg_func pvar_func_NDAttrPlotRegister,
    ...
    pvar_func_NDTransformRegister, pvar_func_aCalcMonitorMemRegister,
    ...
    pvar_func_dbrestoreRegister, pvar_func_drvAHxxxRegister,
    ...
    pvar_func_drvTetrAMMRegister, pvar_func_interpRegister,
...
int quadEMTestApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/quadEM-R9-1";
    ...
    pvar_func_drvAsynIPPortRegisterCommands();
    pvar_func_drvAsynIPServerPortRegisterCommands();
    pvar_func_drvNSLS2_EMRegister();
    pvar_func_drvNSLS_EMRegister();
...
/* quadEMTestApp_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"quadEMTestApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    quadEMTestApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
