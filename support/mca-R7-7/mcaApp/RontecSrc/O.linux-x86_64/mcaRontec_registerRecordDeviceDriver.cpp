...
/* Generated from ../O.Common/mcaRontec.dbd */
...
epicsShareExtern reg_func pvar_func_aCalcMonitorMemRegister,
    ...
    pvar_func_mcaRontecRegister, pvar_func_save_restoreRegister,
...
int mcaRontec_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/mca-R7-7";
...
/* mcaRontec_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"mcaRontec_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    mcaRontec_registerRecordDeviceDriver(*iocshPpdbbase);
}
