...
/* Generated from ../O.Common/mw100ex.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devMW100_ai,
    *pvar_dset_devAoSoft, *pvar_dset_devAoSoftRaw,
    *pvar_dset_devAoSoftCallback, *pvar_dset_devMW100_ao,
    ...
    *pvar_dset_devBoDbState, *pvar_dset_devMW100_bo,
    ...
    *pvar_dset_devLiGeneralTime, *pvar_dset_devMW100_longin,
    ...
    *pvar_dset_devMbboSoftCallback, *pvar_dset_devMW100_mbbo,
    ...
    *pvar_dset_devSiEnviron, *pvar_dset_devMW100_stringin,
...
static const char * const deviceSupportNames[] = {
    ...
    "devMW100_ai", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
    "devMW100_ao", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devMW100_bi", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState",
    "devMW100_bo", "devCalcoutSoft", "devCalcoutSoftCallback",
    "devEventSoft", "devHistogramSoft", "devLiSoft", "devLiSoftCallback",
    "devLiGeneralTime", "devMW100_longin", "devLoSoft",
    "devLoSoftCallback", "devLsiSoft", "devLsiEnviron", "devLsoSoft",
    "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft", "devMbbiSoftRaw",
    "devMbbiSoftCallback", "devMW100_mbbi", "devMbbiDirectSoft",
    "devMbbiDirectSoftRaw", "devMbbiDirectSoftCallback", "devMbboSoft",
    "devMbboSoftRaw", "devMbboSoftCallback", "devMW100_mbbo",
    ...
    "devSiGeneralTime", "devSiEnviron", "devMW100_stringin", "devSoSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devMbbiSoftCallback, pvar_dset_devMW100_mbbi,
...
epicsShareExtern drvet *pvar_drvet_drvMW100;
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    pvar_func_dbndInitialize, pvar_func_mw100Register,
...
int mw100ex_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/Yokogawa_DAS-R1-0-0";
...
/* mw100ex_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"mw100ex_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    mw100ex_registerRecordDeviceDriver(*iocshPpdbbase);
}
