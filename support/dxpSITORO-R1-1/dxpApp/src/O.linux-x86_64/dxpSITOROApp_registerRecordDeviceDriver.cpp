...
/* Generated from ../O.Common/dxpSITOROApp.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "mbbo", "mbboDirect", "mca", "permissive", "printf", "scalcout",
...
epicsShareExtern reg_func pvar_func_NDAttrPlotRegister,
    ...
    pvar_func_NDColorConvertRegister, pvar_func_NDDxpRegister,
    ...
    pvar_func_dbrestoreRegister, pvar_func_dxpMEDRegistrar,
    pvar_func_fastSweepRegister, pvar_func_interpRegister,
    pvar_func_parseRegister, pvar_func_saveDataRegistrar,
...
int dxpSITOROApp_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/dxpSITORO-R1-1";
...
/* dxpSITOROApp_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"dxpSITOROApp_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    dxpSITOROApp_registerRecordDeviceDriver(*iocshPpdbbase);
}
