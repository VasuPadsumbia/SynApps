...
/* Generated from ../O.Common/testIPServer.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_asynInterposeFlushRegister, pvar_func_asynPortTestRegister,
    ...
    pvar_func_ipEchoServer2Register, pvar_func_ipEchoServerRegister,
    pvar_func_ipSNCServerRegistrar, pvar_func_syncInitialize,
...
int testIPServer_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/vasu/synApps/support/asyn-R4-33";
    ...
    pvar_func_asynPortTestRegister();
    pvar_func_asynRegister();
    pvar_func_dbndInitialize();
    pvar_func_drvAsynIPPortRegisterCommands();
    pvar_func_drvAsynIPServerPortRegisterCommands();
    pvar_func_ipEchoServer2Register();
    pvar_func_ipEchoServerRegister();
    pvar_func_ipSNCServerRegistrar();
...
/* testIPServer_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testIPServer_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testIPServer_registerRecordDeviceDriver(*iocshPpdbbase);
}
