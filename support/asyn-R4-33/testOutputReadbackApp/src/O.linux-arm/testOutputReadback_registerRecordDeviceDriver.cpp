...
/* Generated from ../O.Common/testOutputReadback.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_testOutputReadbackRegister,
...
int testOutputReadback_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_testOutputReadbackRegister();
    pvar_func_tsInitialize();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* testOutputReadback_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testOutputReadback_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testOutputReadback_registerRecordDeviceDriver(*iocshPpdbbase);
}
