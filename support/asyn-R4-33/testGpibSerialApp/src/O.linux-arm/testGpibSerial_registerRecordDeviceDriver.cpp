...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "devAiTestGpib", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "asynAoInt32", "asynAoFloat64", "devAoTestGpib",
    "asynRecordDevice", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "asynBiInt32", "asynBiUInt32Digital", "devBiTestGpib",
    "devBoSoft", "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "asynBoInt32", "asynBoUInt32Digital", "devBoTestGpib",
    ...
    "asynLiUInt32Digital", "devLiTestGpib", "devLoSoft",
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_echoDriverRegister, pvar_func_rsrvRegistrar,
