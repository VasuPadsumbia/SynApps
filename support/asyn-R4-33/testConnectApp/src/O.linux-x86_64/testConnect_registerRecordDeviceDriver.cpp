...
/* Generated from ../O.Common/testConnect.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_testConnectRegister,
...
int testConnect_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_testConnectRegister();
    pvar_func_tsInitialize();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* testConnect_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testConnect_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testConnect_registerRecordDeviceDriver(*iocshPpdbbase);
}
