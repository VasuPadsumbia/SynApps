...
/* Generated from ../O.Common/testOutputCallback.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_syncInitialize, pvar_func_testOutputCallbackRegister,
...
int testOutputCallback_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    pvar_func_testOutputCallbackRegister();
    pvar_func_tsInitialize();
    iocshRegisterVariable(vardefs);
    return 0;
}

/* testOutputCallback_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"testOutputCallback_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    testOutputCallback_registerRecordDeviceDriver(*iocshPpdbbase);
}
